...
class Node
{
	...
	std::string m_name;
	int m_imguiId;
	DirectX::XMFLOAT4X4 m_localTransform;		// stored in row major upfront, in the Node's ctor, taken from importer transform, should be equal to DirectX::XMMatrixIdentity() with proper pivots
