...
/// \brief	by default set to output mode
/// \brief	the mode is changed dynamically depending on print/log/read operation request
///=============================================================
...
public:
	...
	/// \brief	get current console's Code Page. for a list of code pages check link: https://docs.microsoft.com/el-gr/windows/desktop/Intl/code-page-identifiers
