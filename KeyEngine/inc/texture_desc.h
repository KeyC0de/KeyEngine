...
const D3D11_TEXTURE2D_DESC createTextureDescriptor( const unsigned width, const unsigned height, const DXGI_FORMAT format, const BindFlags bindFlags, const CpuAccessFlags cpuAccessFlags, const bool bCube, const TextureUsage usage );
