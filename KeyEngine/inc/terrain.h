...
public:
	...
	Terrain( Graphics &gph, const int length, const int width, const std::string &heightMapfilename = "", const float initialScale = 1.0f, const DirectX::XMFLOAT3 &initialRot = {0.0f, 0.0f, 0.0f}, const DirectX::XMFLOAT3 &initialPos = {0.0f, 0.0f, 0.0f}, const int normalizeAmount = 4, const int terrainAreaUnitMultiplier = 10 );
