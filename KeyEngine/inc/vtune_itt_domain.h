...
// ITT task end
#	define VTUNE_ITT_TASK_END							__itt_task_end( ittDomain );
...
#	define VTUNE_ITT_TASK_BEGIN( strHandle )			(void) 0;
#	define VTUNE_ITT_TASK_END							(void) 0;
#	define VTUNE_ITT_SET_THREAD_NAME( threadName )		(void) 0;
#	define VTUNE_ITT_PAUSE								(void) 0;
#	define VTUNE_ITT_RESUME								(void) 0;
