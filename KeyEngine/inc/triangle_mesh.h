...
struct TriangleMesh
{
	...
	TriangleMesh( const ver::Buffer& vertices,
	...
	void setNormalsIndependent() cond_noex
	{
		...
		for ( size_t i = 0; i < m_indices.size(); i += 3 )
		{
			...
			XMStoreFloat3( &v0.getMember<MemberType::Normal>(), n );
			XMStoreFloat3( &v1.getMember<MemberType::Normal>(), n );
			XMStoreFloat3( &v2.getMember<MemberType::Normal>(), n );
		}
	}
};