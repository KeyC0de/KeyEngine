	...
	m_swapChainFlags{0u}
{
	...
	swapChainDesc.SwapMaterial = DXGI_SWAP_EFFECT_DISCARD;	// dirty rectangles are incompatible with _DISCARD
	...
	unsigned newHeight )
{
	...
	{
	// assemble all bound RTV & DSVs, clear them & empty their shared_ptrs
