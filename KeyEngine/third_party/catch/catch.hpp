...
// WARNING: Ideally this would be also constrained against the various char types,
...
namespace Catch {
	namespace {
		...
		struct NoColourImpl : IColourImpl {
			...
			static IColourImpl *getInstance() {
...
namespace Catch {
	...
	static IColourImpl *platformColourInstance() { return NoColourImpl::getInstance(); }
